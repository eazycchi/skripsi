        ...
        <div class="col-lg-6" style="color:#00264d;">
            <form action="" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" id="k_pengawas" name="k_pengawas" value="<?= $sensus['k_pengawas']; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" id="k_pencacah" name="k_pencacah" value="<?= $sensus['k_pencacah']; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="honor" name="honor" value="<?= $sensus['honor']; ?>">
