        ...
        <div class="col-lg-6" style="color:#00264d;">
            <form action="" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="deskripsi" name="deskripsi" value="<?= $kriteria['deskripsi']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="target" name="target" value="<?= $kriteria['target']; ?>" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-3">
